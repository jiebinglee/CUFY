...
namespace ChinaUnicom.Fuyang.Framework.Logging
{
    ...
    public class FileAppender : log4net.Appender.TextWriterAppender
    {
        ...
        override public void ActivateOptions()
        {
            ...
            {
                LogLog.Warn(null,"FileAppender: File option not set for appender [" + Name + "].");
                LogLog.Warn(null,"FileAppender: Are you using FileAppender instead of ConsoleAppender?");
            }
        }
        ...
        virtual protected void OpenFile(string fileName, bool append)
        {
            ...
            lock (this)
            {
                ...
                LogLog.Debug(null,"FileAppender: Opening file for writing [" + fileName + "] append [" + append + "]");
